...
function StreamAlerts(config)
{
  ...
  self.findStreams = function() {
    return new Promise((resolve, reject) => {
      let search = {
        url: 'https://api.twitch.tv/kraken/streams?limit=100&stream_type=live&game='+encodeURIComponent(self.config.gameName)+'&channel='+encodeURIComponent(self._channels.join()),
