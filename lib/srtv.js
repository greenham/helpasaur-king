        ...
        if (value == undefined) {
          ...
          apiRequest(req, function (error, response, body) {
            if (error) {
              ...
              reject(
                `Unexpected response from SRTV during login: ${JSON.stringify(
                  response
                )}`
              );
            }
  ...
  return new Promise((resolve, reject) => {
    ...
    apiRequest(req, function (error, response, body) {
      if (error) {
        ...
        reject(
          `Unexpected response from SRTV during getRace: ${JSON.stringify(
            response
          )}`
        );
      }
      ...
      .then((token) => {
        ...
        apiRequest(req, function (error, response, body) {
          if (error) {
            ...
            reject(
              `Unexpected response from SRTV during createRace: ${JSON.stringify(
                response
              )}`
            );
          }
      ...
      .then((token) => {
        ...
        apiRequest(req, function (error, response, body) {
          if (error) {
            ...
            reject(
              `Unexpected response from SRTV during sendChatMessage: ${JSON.stringify(
                response
              )}`
            );
          }
  ...
  return new Promise((resolve, reject) => {
    ...
    apiRequest(req, function (error, response, body) {
      if (error) {
        ...
        reject(
          `Unexpected response from SRTV during getChatHistory: ${JSON.stringify(
            response
          )}`
        );
      }
  ...
  return new Promise((resolve, reject) => {
    ...
    apiRequest(req, function (error, response, body) {
      if (error) {
        ...
        reject(
          `Unexpected response from SRTV during getRaceEntries: ${JSON.stringify(
            response
          )}`
        );
      }
