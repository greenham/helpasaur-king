  ...
  return new Promise((resolve, reject) => {
    ...
    apiRequest(req, function(error, response, body) {
      if (error) {
        ...
        reject(`Unexpected response from SRTV during getChatHistory: ${JSON.stringify(response)}`);
      }
    });
  });
}
  ...
  return new Promise((resolve, reject) => {
    ...
    apiRequest(req, function(error, response, body) {
      if (error) {
        ...
        reject(`Unexpected response from SRTV during getRaceEntries: ${JSON.stringify(response)}`);
      }
    });
  });
}
