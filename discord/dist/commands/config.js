...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .setName("enable")
        .setDescription("Be sure to set the stream-alerts-channel if you enable these!")
        .setRequired(true)))
        .addSubcommand((subcommand) => subcommand
        ...
        .setDescription("Enable/disable alert for one hour prior to the weekly race")
        .addBooleanOption((option) => option
        .setName("enable")
        .setDescription("Be sure to set the weekly-alerts-channel if you enable this!")
        .setRequired(true)))
        .addSubcommand((subcommand) => subcommand
        .setName("weekly-race-room-alert")
        .setDescription("Enable/disable message with a link to the weekly race room upon creation")
        .addBooleanOption((option) => option
        .setName("enable")
        .setDescription("Be sure to set the weekly-alerts-channel if you enable this!")
        .setRequired(true)))
    ...
    async execute(interaction) {
        ...
        const currentGuildConfig = interaction.client.config.guilds.find((g) => g.id === interaction.guildId);
        ...
        await this.helpaApi.api.patch(`/api/discord/guild/${interaction.guildId}`, guildUpdate);
        await interaction.editReply({
