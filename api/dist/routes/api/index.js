...
router.use("/streamAlerts", requireJwtToken, guard.check([["admin"], ["service"]]), require("./stream-alerts"));
router.use("/configs", requireJwtToken, guard.check([["admin"], ["service"]]), require("./configs"));
