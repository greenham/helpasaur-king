...
router.post("/:twitchUserId/lists/:listName/entries", requireJwtToken, guard.check("service"), async (req, res) => {
...
router.get("/:twitchUserId/lists/:listName/entries/random", requireJwtToken, guard.check("service"), async (req, res) => {
    const twitchUserId = req.params.twitchUserId ?? false;
    if (!twitchUserId) {
        res.status(400).json({ message: "Missing twitchUserId!" });
        return;
...
router.delete("/:twitchUserId/lists/:listName/entries/:entryId", requireJwtToken, guard.check("service"), async (req, res) => {
    const twitchUserId = req.params.twitchUserId ?? false;
    if (!twitchUserId) {
        res.status(400).json({ message: "Missing twitchUserId!" });
        return;
...
router.get("/:twitchUserId/lists/:listName", requireJwtToken, guard.check("service"), async (req, res) => {
    const twitchUserId = req.params.twitchUserId ?? false;
    if (!twitchUserId) {
        res.status(400).json({ message: "Missing twitchUserId!" });
        return;
...
router.delete("/:twitchUserId/lists/:listName", requireJwtToken, guard.check("service"), async (req, res) => {
    const twitchUserId = req.params.twitchUserId ?? false;
    if (!twitchUserId) {
        res.status(400).json({ message: "Missing twitchUserId!" });
        return;
